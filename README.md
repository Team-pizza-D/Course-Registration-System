...
Learn how to test the codes and dealing with errors.

Learn how to connect between more than one class to each others
...
Learn how to connect the GUI with the Classes and DataBase and manage it.

Learn how to adjust windows sizes.

Learn how to connect interface widgets with codes.
